...
/**
 * Thrown when a request cannot be completed due to a conflict with the current state of the
 * resource (e.g., trying to create a Muscle with a name that already exists).
 *
...
public class DataConflictException extends RuntimeException {
   ...
   *
   * @param messageKey The key for the i18n error message (e.g., "error.muscle.name.exists").
